...
// LightningStrike: faithful port of upstream lib/three/LightningStrike.js adapted to three r183.
...
export class LightningStrike extends BufferGeometry {
    ...
    createMesh() {
        ...
        if ( ! this.isStatic ) {
            this.index.setUsage( DynamicDrawUsage );
            this.positionAttribute.setUsage( DynamicDrawUsage );
            if ( this.generateUVs ) {
                this.uvsAttribute.setUsage( DynamicDrawUsage );
            }
        }
