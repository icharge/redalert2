...
export class Aircraft {
    ...
    private updateBaseLight(): void {
        this.baseExtraLight = new THREE.Vector3().setScalar(this.lighting.computeNoAmbient(this.objectArt.lightingType as any, this.gameObject.tile) + this.rules.audioVisual.extraAircraftLight);
    }
    updateLighting(): void {
