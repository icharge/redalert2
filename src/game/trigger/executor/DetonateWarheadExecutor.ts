...
export class DetonateWarheadExecutor extends TriggerExecutor {
    execute(game: any): void {
        ...
        warhead.detonate(game, weapon.damage, tile, elevation, Coords.tile3dToWorld(tile.rx + 0.5, tile.ry + 0.5, tile.z + elevation), zone, bridge ? CollisionType.OnBridge : CollisionType.None, game.createTarget(bridge, tile), undefined, SpecialWarheadType.None, undefined, undefined);
    }
}
